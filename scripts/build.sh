...
WEBAPP_VIEWER_ROOT_PATH="${DIR}/..//app/frontend-viewer"
WEBAPP_VIEWER_BUILD_PATH="${DIR}/..//app/backend/static-viewer"
...
# copy the shared_code files from functions to the backend
cd ../backend
mkdir -p ./shared_code
...
cd ../backend
zip -q -r ${BINARIES_OUTPUT_PATH}/webappviewer.zip .
cd $DIR
echo "Successfully zipped webapp-viewer"
echo -e "\n"
